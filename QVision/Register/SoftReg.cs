...
namespace QVision.Register
{
    class SoftReg
    {
        ...
        /// </summary>
        /// <returns></returns>
        public string GetDiskVolumnSerialNumber()
        {
        ...
        {
            string strNum = GetCpu() + GetDiskVolumnSerialNumber();
        ...
        public int[] intNumber = new int[25];   //存储ACSCII码值
